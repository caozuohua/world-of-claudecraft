...
export const en_CA: EnTranslations = {
  ...
  "guide": {
    ...
    "settingsPage": {
      ...
      "audioBody": "The options window is not all pixels. An Audio tab holds separate volume controls for effects, music, and voice, and the Interface section carries a language picker that relocalizes the whole interface on the spot, no reload needed."
    },
    "combat": {
      ...
      "queueBody": "You do not have to time your presses to the frame. Press your next ability while the current one is still casting and it is queued, firing the instant the cast completes, so practiced play flows without gaps. Some melee strikes work the same way, riding out on your next weapon swing.",
    ...
    "glossary": {
      ...
      "renownTerm": "Renown",
      "renownDef": "The lifetime score your deeds add up to. It only ever climbs, and the realm keeps standings of it in the Book of Deeds.",
      "heroicTerm": "Heroic",
      ...
      "spiritHealerDef": "The keeper hovering over every graveyard, who can raise your ghost on the spot at the price of a passing weakness.",
    ...
    "dungeonsPage": {
      ...
      "heroicLockoutBody": "Normal dungeons can be run all day. Heroic asks patience: each dungeon rewards one heroic clear per day, and the raid keeps a daily lockout for each difficulty. A cleared run always stays open to its own party, so nobody is locked away from loot they earned.",
    ...
    "wishPage": {
      ...
      "i2Body": "When you fall you rise as a ghost at the nearest graveyard. Run back to your body to revive free, or take the Spirit Healer's instant raise and carry a short-lived weakness for the convenience. No experience, gear, or coin is ever lost, so it is safe to take risks and learn.",
    ...
    "gear": {
      ...
      "soulboundBody": "Many prized pieces are soulbound, bound to your character from the moment you acquire them. A soulbound item cannot be traded, mailed, sold to a vendor, or listed on the market; it is part of your story now, and no one else can carry it for you.",
    ...
    "economy": {
      ...
      "mailHow": "Collecting works the same in reverse: stand at any pillar to read your letters and take what they carry into your purse and bags. Letters do not wait forever, so collect before the raven gives up on you. Two things the post refuses outright: soulbound items and quest goods travel with you or not at all. And keep an eye on the pillar after a good turn-in; some questgivers write.",
    ...
    "stats": {
      ...
      "hasteTitle": "Haste",
      "hasteBody": "Haste is one stat that quickens everything you do: melee swings, ranged shots, and spellcasting all speed up together. It comes from gear, most notably armor-set bonuses, and a few abilities grant a burst of it. Your sheet shows it as Haste Rating.",
