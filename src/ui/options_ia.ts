  ...
  interface: [
    ...
    },
    {
      ...
      rows: [
        ...
        // account setting (accounts.deed_broadcasts), not a settings.ts key, so
        // it is a bespoke keyless row like the two above. The painter renders it
        // through buildDeedBroadcastRow only when main.ts wired the online seam.
        {
 ...
 *  flag and the collapse toggles owned by the quest-tracker and deed-tracker
 *  headers. */
